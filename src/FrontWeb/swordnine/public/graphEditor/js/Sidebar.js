...
Sidebar.prototype.addEntityPalette = function(expand)
{
	...
	// Reusable cells
	var field = new mxCell('value', new mxGeometry(0, 0, 100, 26), 'text;strokeColor=none;fillColor=none;align=left;verticalAlign=top;spacingLeft=4;spacingRight=4;overflow=hidden;rotatable=0;points=[[0,0.5],[1,0.5]];portConstraint=eastwest;');
	field.vertex = true;

	
	// Default tags
	var dt = 'Entity static class ';
	this.setCurrentSearchEntryLibrary('entityRelation');
	
	var fns = [
		// this.addDataEntry('table title', 180, 150, 'Table with Title 2', ''),
		this.addDataEntry('table 1', 180, 150, 'Talbe', ''),
	...
	this.addPaletteFunctions('entityRelation', mxResources.get('entityRelation'), expand || false, fns);
	this.setCurrentSearchEntryLibrary();
};
/**
 * Adds the general palette to the sidebar.
