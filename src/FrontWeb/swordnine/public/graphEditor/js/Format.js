...
ArrangePanel.prototype.init = function()
{
	...
	{
		// this.container.appendChild(this.addFlip(this.createPanel()));//DELETE
	}
	...
	{
		// this.container.appendChild(this.addTable(this.createPanel()));//DELETE
	}
...
TextFormatPanel.prototype.addFont = function(container)
{
	...
	else
	{
		...
		// wrapper3.appendChild(tablePanel);//DELETE
