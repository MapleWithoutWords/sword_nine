...
EditorUi.prototype.showConfirmDialog=function (title,funTitle,canTitle,fun,canFunc) {
	var dlg=new ConfirmDialog(this,title,canFunc,fun,canTitle,funTitle)
	this.showDialog(dlg.container,180,75,true,true)
	dlg.init();
}
